      ...
      {!isOpen && (
        <main>
          ...
          <div className="flex items-center justify-center mt-5">
            ...
            <div className="bg-(--green) h-[3] w-9 md:w-50 lg:w-80"></div>

            <h1 className="text-shadow-sm font-bold px-1">Nuestra Historia</h1>

            <div className="bg-(--green) h-[3] w-9 md:w-50 lg:w-80"></div>

          </div>

          <div className="xl:flex m-15 xl:mx-50">
            <div className="flex justify-center xl:w-1/3 ">
              <img className="shadow-xl rounded" src="sobre-nosotros.jpg"></img>
            </div>
            <div className="flex mt-10 xl:w-2/3">
              <p className="text-center md:mx-10 lg:mx-30 xl:ml-20 xl:text-xl xl:text-left">Somos José e Ivanna, actriz y veterinaria de profesión, las creadoras de Soy Torta Vegan. Nuestro emprendimiento nació en pandemia por la necesidad de pagar nuestros estudios, y a día de hoy se ha convertido en nuestro proyecto familiar más importante, buscando crear productos para todas y todos aquellos que tienen restricciones en su alimentación y no siempre encuentran opciones aptas para su consumo. 🤍</p>
            </div>
